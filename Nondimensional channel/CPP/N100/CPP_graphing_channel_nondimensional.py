...
data = []
file_path = 'flowdata_channel_nondimensional_CPP_N100_iter360000_CFL05_beta1.000000.txt'
...
data_res = np.loadtxt('residues_channel_nondimensional_CPP_N100_iter360000_CFL05_beta1.000000.txt')
