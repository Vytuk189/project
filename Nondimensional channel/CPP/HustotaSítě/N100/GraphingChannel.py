...
data = []
file_path = 'flowdata_channel_nondimensional_N100_iter150000_CFL05_beta1.000000.txt'
...
# Load the data
data_time = np.loadtxt('times_channel_nondimensional_CPP_N100_iter150000_CFL05_beta1.000000.txt')
data_res = np.loadtxt('residues_channel_nondimensional_CPP_N100_iter150000_CFL05_beta1.000000.txt')
...
ax2.set_xticks(iterations[::10000])  # Change this step as needed

# Round the simulation time to one decimal place for tick labels
rounded_time = np.round(data_time[::10000], 1)  # Round the time values
