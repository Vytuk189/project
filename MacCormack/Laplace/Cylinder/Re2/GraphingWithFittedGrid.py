...
data = []
file_path = 'flowdata_cylinder_NR20.000000_Re2.000000_Iter1200000.txt'
...
# Load the data
data_res = np.loadtxt('residues_cylinder_NR20.000000_Re2.000000_Iter1200000.txt')
data_time = np.loadtxt('times_channel_nondimensional_CPP_DR20.000000_iter1200000_CFL05_beta1.000000.txt')
...
plt.title('Re = 2: Průběh reziduí', fontsize = 18)
ax1.legend()
...
ax2.set_xticks(iterations[::200000])  # Change this step as needed

# Round the simulation time to one decimal place for tick labels
rounded_time = np.round(data_time[::200000], 1)  # Round the time values
