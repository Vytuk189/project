...
% Open the file
filename = 'DFGPeriodic_DataPart_Counter9990.txt';
...
t = title('Periodický případ: Tlak P', 'Color', 'k', 'FontWeight', 'bold', 'FontSize', 30);
drawnow; % ensure rendering happens before moving title
set(t, 'Units', 'normalized', 'Position', [0.5, 1.05, 0]);
set(gcf, 'Color', 'w');
...
t = title('Periodický případ: Horizontální rychlost U', 'Color', 'k', 'FontWeight', 'bold', 'FontSize', 30);
drawnow; % ensure rendering happens before moving title
set(t, 'Units', 'normalized', 'Position', [0.5, 1.05, 0]);
set(gcf, 'Color', 'w');
set(gca, 'Color', 'w', 'XColor', 'k', 'YColor', 'k', 'TickDir', 'out', 'FontSize', 12);
...
t = title('Periodický případ: Vertikální rychlost V', 'Color', 'k', 'FontWeight', 'bold', 'FontSize', 30);
drawnow; % ensure rendering happens before moving title
set(t, 'Units', 'normalized', 'Position', [0.5, 1.05, 0]);
set(gcf, 'Color', 'w');
set(gca, 'Color', 'w', 'XColor', 'k', 'YColor', 'k', 'TickDir', 'out', 'FontSize', 12);
...
t = title('Periodický případ: Celková rychlost', 'Color', 'k', 'FontWeight', 'bold', 'FontSize', 30);
drawnow; % ensure rendering happens before moving title
set(t, 'Units', 'normalized', 'Position', [0.5, 1.05, 0]);
set(gcf, 'Color', 'w');
set(gca, 'Color', 'w', 'XColor', 'k', 'YColor', 'k', 'TickDir', 'out', 'FontSize', 12);
...
t = title('Periodický případ: Proudnice', 'Color', 'k', 'FontWeight', 'bold', 'FontSize', 20);
drawnow; % ensure rendering happens before moving title
set(t, 'Units', 'normalized', 'Position', [0.5, 1.05, 0]);
