...
data = []
file_path = 'flowdata_cylinder_NR40.000000_Re2.000000_Iter1000000.txt'
...
# Load the data
data_res = np.loadtxt('residues_cylinder_NR25.000000_Re2.000000_Iter100000.txt')
data_time = np.loadtxt('times_channel_nondimensional_CPP_DR25.000000_iter100000_CFL05_beta1.000000.txt')
