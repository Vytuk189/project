...
% Open the file
filename = 'flowdata_cylinder_NR40.000000_Re10.000000_Iter300000.txt';
...
% 
% t = title('Re = 10: Tlak P', 'Color', 'k', 'FontWeight', 'bold', 'FontSize', 30);
...
% ylabel('Y', 'Color', 'k', 'FontWeight', 'bold', 'FontSize', 14);
% 
% t = title('Re = 10: Horizontální rychlost U', 'Color', 'k', 'FontWeight', 'bold', 'FontSize', 30);
% drawnow; % ensure rendering happens before moving title
% set(t, 'Units', 'normalized', 'Position', [0.5, 1.05, 0]);
% set(gcf, 'Color', 'w');
% set(gca, 'Color', 'w', 'XColor', 'k', 'YColor', 'k', 'TickDir', 'out', 'FontSize', 12);
...
% ylabel('Y', 'Color', 'k', 'FontWeight', 'bold', 'FontSize', 14);
% 
% t = title('Re = 10: Vertikální rychlost V', 'Color', 'k', 'FontWeight', 'bold', 'FontSize', 30);
% drawnow; % ensure rendering happens before moving title
% set(t, 'Units', 'normalized', 'Position', [0.5, 1.05, 0]);
% set(gcf, 'Color', 'w');
% set(gca, 'Color', 'w', 'XColor', 'k', 'YColor', 'k', 'TickDir', 'out', 'FontSize', 12);
...
% ylabel('Y', 'Color', 'k', 'FontWeight', 'bold', 'FontSize', 14);
% 
% t = title('Re = 10: Celková rychlost', 'Color', 'k', 'FontWeight', 'bold', 'FontSize', 30);
% drawnow; % ensure rendering happens before moving title
% set(t, 'Units', 'normalized', 'Position', [0.5, 1.05, 0]);
% set(gcf, 'Color', 'w');
% set(gca, 'Color', 'w', 'XColor', 'k', 'YColor', 'k', 'TickDir', 'out', 'FontSize', 12);
...
t = title('Re = 10: Proudnice', 'Color', 'k', 'FontWeight', 'bold', 'FontSize', 20);
drawnow; % ensure rendering happens before moving title
set(t, 'Units', 'normalized', 'Position', [0.5, 1.05, 0]);
