...
data = []
file_path = 'flowdata_cylinder_NR40.000000_Re30.000000_Iter430000.txt'
...
# Load the data
data_res = np.loadtxt('residues_cylinder_NR40.000000_Re30.000000_Iter400000.txt')
data_time = np.loadtxt('times_channel_nondimensional_CPP_DR40.000000_iter400000_CFL05_beta1.000000.txt')
