...
data = []
file_path = 'flowdata_channel_nondimensional_N100_iter120000_CFL05_beta1.000000.txt'
...
# Load the data
data_time = np.loadtxt('times_channel_nondimensional_CPP_N100_iter120000_CFL05_beta1.000000.txt')
data_res = np.loadtxt('residues_channel_nondimensional_CPP_N100_iter120000_CFL05_beta1.000000.txt')
...
plt.title('MacCormack: Rezidua při Re=10', fontsize=16, pad=12)
ax1.legend()
