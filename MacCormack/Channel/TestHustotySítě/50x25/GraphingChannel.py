...
data = []
file_path = 'flowdata_channel_nondimensional_N50_iter290000_CFL05_beta1.000000.txt'
...
# Load the data
data_time = np.loadtxt('times_channel_nondimensional_CPP_N50_iter90000_CFL05_beta1.000000.txt')
data_res = np.loadtxt('residues_channel_nondimensional_CPP_N50_iter90000_CFL05_beta1.000000.txt')
...
rounded_time = np.round(data_time[::5000], 1)  # Round the time values
