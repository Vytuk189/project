...
data = []
file_path = 'flowdata_cylinder_NR25.000000_Re10.000000_Iter799000.txt'
...
# Load the data
data_res = np.loadtxt('residues_cylinder_NR25.000000_Re10.000000_Iter330000.txt')
data_time = np.loadtxt('times_channel_nondimensional_CPP_DR25.000000_iter330000_CFL05_beta1.000000.txt')
