...
data = []
file_path = 'flowdata_cylinder_NR25.000000_Re40.000000_Iter110000.txt'
...
# Load the data
data_res = np.loadtxt('residues_cylinder_NR25.000000_Re40.000000_Iter110000.txt')
data_time = np.loadtxt('times_channel_nondimensional_CPP_DR25.000000_iter110000_CFL05_beta1.000000.txt')
