...
data = []
file_path = 'flowdata_cavity_N100_Re10.000000_iter141000.txt'
...
plt.title('Re = 10: Horizontální rychlost U')
plt.xlabel('x')
plt.ylabel('y')
...
plt.title('Re = 10: Vertikální rychlost V')
plt.xlabel('x')
plt.ylabel('y')
plt.gca().set_aspect('equal', adjustable='box')  # Ensure axes are proportional
# Plot the second mesh, only where binary_data is 0, set color to white
...
plt.colorbar(label='V')
plt.title('Re = 10: celková rychlost')
plt.xlabel('x')
plt.ylabel('y')
plt.gca().set_aspect('equal', adjustable='box')  # Ensure axes are proportional
# Plot the second mesh, only where binary_data is 0, set color to white
...
data_res = np.loadtxt('residues_cavity_N100_Re10.000000_iter140000.txt')
