...
# Load the data
data_time = np.loadtxt('times_channel_nondimensional_CPP_N50_iter280000_CFL05_beta1.000000.txt')
data_res = np.loadtxt('residues_channel_nondimensional_CPP_N50_iter280000_CFL05_beta1.000000.txt')
