...
data = []
file_path = 'flowdata_channel_nondimensional_N100_iter290000_CFL05_beta1.000000.txt'
...
# Load the data
data_time = np.loadtxt('times_channel_nondimensional_CPP_N100_iter280000_CFL05_beta1.000000.txt')
data_res = np.loadtxt('residues_channel_nondimensional_CPP_N100_iter280000_CFL05_beta1.000000.txt')
...
#plt.title('L.-F.: Rezidua při síti ' + str(N-3) + "x" + str(M-1), fontsize=16, pad=12)
plt.title(r'L.-F.: Rezidua pro $\,\xi$=0.0001', fontsize=16, pad=12)
ax1.legend()
