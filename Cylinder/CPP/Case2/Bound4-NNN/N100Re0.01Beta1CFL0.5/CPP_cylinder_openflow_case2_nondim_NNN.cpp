...
The boundary conditions in this specific case are  Neumann everywhere (Case 4)
*/
...
int main(){
    ...
    while (counter < iter) {
        ...
        for (int j = 0; j < M + 1; ++j) {
            // Pressure/U speed/V speed dont change between the first layer and the layer after it
        ...
        */
        ...
        if(counter % 10 == 0){
        std::cout << "***************************************************************\n";
        std::cout << "Case NNN: N=" << N << ", M=" << M << ", L=" << L << ", H=" << H << ", Re=" << Re << ", beta=" << beta <<  "\n";
