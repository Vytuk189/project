...
plt.title('Horizontální rychlost U pro případ: '+str(case) + ', Re = ' + str(Re) + ', N = ' + str(N))
plt.xlabel('x')
plt.ylabel('y')
...
plt.figtext(0.5, 0.005, 'This is a secondary or caption', ha='center', va='center', fontsize=10)
...
plt.title('Vertikální rychlost V pro případ: '+str(case) + ', Re = ' + str(Re) + ', N = ' + str(N))
plt.xlabel('x')
plt.ylabel('y')
plt.gca().set_aspect('equal', adjustable='box')  # Ensure axes are proportional
# Plot the second mesh, only where binary_data is 0, set color to white
...
plt.title('Tlak P pro případ: '+str(case) + ', Re = ' + str(Re) + ', N = ' + str(N))
plt.xlabel('x')
plt.ylabel('y')
plt.gca().set_aspect('equal', adjustable='box')  # Ensure axes are proportional
# Plot the second mesh, only where binary_data is 0, set color to white
...
plt.xlabel('Iterace')
plt.ylabel('Reziduum')
plt.title('Hodnota reziduí pro případ: '+str(case) + ', Re = ' + str(Re) + ', N = ' + str(N))
plt.legend()
