...
data = []
file_path = 'flowdata_cylinder_NR5.000000_Re40.000000_Iter10000.txt'
...
plt.streamplot(X, Y, u_speeds_grid, v_speeds_grid, color='black', linewidth=0.7, density=8, integration_direction='both', arrowstyle = '-', minlength=1)
plt.xlabel('x')
plt.ylabel('y')
