...
const double max_node_density = 5; //Pocet uzlu na R
...
const double delta_y_max = R/min_node_density;
const int left_zone_count = 2;
const int right_zone_count = 2;
const int vert_zone_count = 2;


const double x_dense_left = center_x - 1.5*R;
const double x_dense_right = center_x + 4*R;
