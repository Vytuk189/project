...
void saveMatrix(const Matrix& past, int iter_number) {
    std::string filename = "flowdata_cylinder2_nondimensional_CPP_N" + std::to_string(N) + "_Re"+std::to_string(Re)+"_iter" + std::to_string(iter_number) + "_CFL05.txt";
