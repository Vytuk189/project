...
plt.figtext(0.5, 0.005, 'Dochází k přenulování tlaku uvnitř válce', ha='center', va='center', fontsize=10)
...
cmap_binary = ListedColormap(["none", "white"])
plt.pcolormesh(X, Y, mask, shading='auto', cmap=cmap_binary)
plt.figtext(0.5, 0.005, 'Nedochází k přenulování tlaku uvnitř válce', ha='center', va='center', fontsize=10)
plt.show()
